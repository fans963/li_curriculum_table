import 'package:li_curriculum_table/core/rust/api/level_exam_score.dart' as rust_api;
...
class LevelExamScoreRemoteDataSource {
  Future<List<LevelExamScoreEntity>> getScores({
    ...
    final List<rust_model.LevelExamScore> rustScores =
        await rust_api.getLevelExamScores(
      username: username,
      password: password,
    );

    return rustScores
        .map((s) => LevelExamScoreEntity(
