        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              _VerticalDivider(),
              Expanded(
                child: _MetaItem(label: '定价', value: detail.price),
              ),
              _VerticalDivider(),
              Expanded(
                child: _MetaItem(label: '页数', value: detail.pages),
              ),
            ],
          ),
        ),
...
class _LocationRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isAvailable =
        location.status.contains('在架') ||
        location.status.contains('可借') ||
        location.status.contains('在馆');
