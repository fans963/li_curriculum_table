        ...
        children: [
          _iosTile(
            ...
            trailing: CupertinoSwitch(
              ...
              onChanged: notifier.setAutoSizeText,
            ),
          ...
          _iosTile(
            ...
            trailing: CupertinoSwitch(
              ...
              onChanged: notifier.setWeeklyScroll,
            ),
...
class _CupertinoAutoSizeSlider extends StatelessWidget {
  ...
  const _CupertinoAutoSizeSlider({
...
class _CupertinoFixedTextSettings extends StatelessWidget {
  ...
  const _CupertinoFixedTextSettings({
    required this.settings,
    required this.notifier,
  });
            ...
            child: Row(
              children: [
                ...
                CupertinoSlidingSegmentedControl<int>(
                  ...
                  onValueChanged: (v) {
                    if (v != null) notifier.setTimetableTextMaxLines(v);
                  },
                  children: const {
                    1: Padding(
        ...
        children: [
          _iosTile(
            ...
            trailing: CupertinoSwitch(
              ...
              onChanged: notifier.setProxyEnabled,
            ),
