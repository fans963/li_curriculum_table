          ...
          if (!settings.useDynamicColor) ...[
            ...
            _iosTile(
              ...
              trailing: Row(
                ...
                children: [
                  Text(
                    settings.colorSchemeType.label,
                    style: TextStyle(
                      fontSize: 15,
      ...
      child: Row(
        ...
        children: [
          Icon(
            icon,
            size: 18,
            color: CupertinoDynamicColor.resolve(color, ctx),
          ),
          const SizedBox(width: 8),
          Text(label),
            ...
            child: Row(
              ...
              children: [
                Icon(
                  ...
                  color: CupertinoColors.systemPurple.resolveFrom(ctx),
                ),
                const SizedBox(width: 8),
                const Text('自定义颜色...'),
              ],
...
class _CupertinoColorPickerDialog extends SignalStatefulWidget {
  ...
  @override
  State<_CupertinoColorPickerDialog> createState() =>
      _CupertinoColorPickerDialogState();
}

class _CupertinoColorPickerDialogState
    extends State<_CupertinoColorPickerDialog> {
