...
class _LevelExamScoreCard extends StatelessWidget {
  ...
  Widget _buildTag(
      BuildContext context, String text, Color bgColor, Color fgColor) {
    return Container(
      ...
      child: Text(text,
          style: Theme.of(context)
              .textTheme
              .bodySmall
              ?.copyWith(color: fgColor, fontSize: 11)),
    );
  }
}
