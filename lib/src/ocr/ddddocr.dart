...
class DdddOcr {
	...
	Future<String> classification(Uint8List imageBytes, {bool pngFix = false}) async {
		...
		try {
			...
			try {
				...
				final indices = _decodeIndices(shape: shape, data: data, charsetLen: _config.charset.length);
