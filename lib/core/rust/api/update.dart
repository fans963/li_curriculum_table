...
// These functions are ignored because they are not marked as `pub`: `do_stream`, `extract_version_from_url`
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `GiteeRelease`
